    ...
    WebViewer(
      {
        ...
        disabledElements: [
          ...
          'searchButton',
          'menuButton',
          'toolGroupButtonScroll',
          'Highlight',
          'rubberStampToolGroupButton',
          'highlightToolGroupButton','strikeoutToolGroupButton','underlineToolGroupButton','squigglyToolGroupButton','stickyToolGroupButton','freeTextToolGroupButton','markInsertTextGroupButton','markReplaceTextGroupButton','shapeToolGroupButton','freeHandToolGroupButton','freeHandHighlightToolGroupButton',
     ...
     setInstance1(instance)
      ...
      documentViewer.on("documentLoaded", function(event) {
        ...
        this.instance.disableElements(['toolsHeader']);
